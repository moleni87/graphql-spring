...
public class CustomGraphQLContextBuilder implements GraphQLServletContextBuilder {
    ...
    private DataLoaderRegistry buildDataLoaderRegistry() {
        ...
        MappedBatchLoader<Long, List<Book>> bookDataLoader = keys -> supplyAsync(() -> bookRepository.findByAuthorIdIn(keys).stream().collect(Collectors.groupingBy(Book::getAuthorId)));
        dataLoaderRegistry.register("bookDataLoader", DataLoader.newMappedDataLoader(bookDataLoader));
